...
*
*/
package org.dot.oplus.OPlusExtras;
...
import org.dot.oplus.OPlusExtras.doze.DozeSettingsActivity;
import org.dot.oplus.OPlusExtras.FileUtils;
import org.dot.oplus.OPlusExtras.modeswitch.*;
import org.dot.oplus.OPlusExtras.preferences.*;
import org.dot.oplus.OPlusExtras.R;
import org.dot.oplus.OPlusExtras.services.*;
import org.dot.oplus.OPlusExtras.slider.SliderConstants;
import org.dot.oplus.OPlusExtras.touch.TouchscreenGestureSettings;
...
public class OPlusExtras extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        Drawable dot = getResources().getDrawable(R.drawable.dot,null);
        int randomColor;
        randomColor = Color.rgb(
        Color.red(rand.nextInt(0xFFFFFF)),
        Color.green(rand.nextInt(0xFFFFFF)),
        Color.blue(rand.nextInt(0xFFFFFF)));
        dot.setTint(randomColor);

        ParticleSystem ps = new ParticleSystem(getActivity(),50,dot,2000);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.dot.oplus.OPlusExtras.services.FPSInfoService.class);
            if (enabled) {
