package org.dot.oplus.OPlusExtras.touch;
...
public class ActionUtils {
    ...
    private static Intent getOPlusExtrasIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("org.dot.oplus.OPlusExtras",
                "org.dot.oplus.OPlusExtras.OPlusExtrasActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("org.dot.oplus.OPlusExtras", "org.dot.oplus.OPlusExtras.touch.ScreenOffLaunchGestureActivity");
